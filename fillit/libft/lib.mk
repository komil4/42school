...
#    Updated: 2019/10/15 21:04:35 by bhoth            ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME=libft.a

SRCS=ft_atoi.c ft_atoi_base.c ft_bzero.c ft_isalnum.c \
	 ft_isalpha.c ft_isascii.c ft_isdigit.c ft_isprint.c \
	 ft_itoa.c ft_lstadd.c ft_lstaddend.c \
	 ...
	 ft_firstchar.c ft_lastchar.c ft_strcpy.c ft_strdel.c \
	 ...
	 ft_lstaddend.c ft_lstdel.c ft_lstdelone.c ft_lstiter.c ft_lstiter.c\
	 ft_lstmap.c ft_lstnew.c ft_positionchar.c

OBJ=ft_atoi.o ft_atoi_base.o ft_bzero.o ft_isalnum.o \
		...
		ft_firstchar.o ft_lastchar.o ft_strcpy.o ft_strdel.o \
		...
		ft_strsub.o ft_strtrim.o ft_tolower.o ft_toupper.o ft_lstadd.o\
		ft_lstaddend.o ft_lstdel.o ft_lstdelone.o ft_lstiter.o ft_lstiter.o\
		ft_lstmap.o ft_lstnew.o ft_positionchar.o
